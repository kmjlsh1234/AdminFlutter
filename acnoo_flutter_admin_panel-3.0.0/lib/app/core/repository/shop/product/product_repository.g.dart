...
class _ProductRepository implements ProductRepository {
  ...
  Future<List<Product>> getProductList(
    ...
    _data.addAll(productSearchParam.toJson());
    final _options = _setStreamType<List<Product>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/v1/products/list',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<CountVo> getProductListCount(
    ProductSearchParam productSearchParam,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  Future<Product> addProduct(ProductAddParam productAddParam) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(productAddParam.toJson());
  ...
  @override
  Future<Product> modProduct(
    int productId,
    ProductModParam productModParam,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(productModParam.toJson());
    final _options = _setStreamType<Product>(
  ...
  @override
  Future<HttpResponse<dynamic>> modProductStatus(
    int productId,
    ProductModStatusParam productModStatusParam,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(productModStatusParam.toJson());
    final _options = _setStreamType<HttpResponse<dynamic>>(
      Options(method: 'PUT', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/v1/products/${productId}/status',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<HttpResponse<dynamic>> delProduct(int productId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
