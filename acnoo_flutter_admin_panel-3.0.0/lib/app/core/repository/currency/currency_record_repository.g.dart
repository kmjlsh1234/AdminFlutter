...
part of 'currency_record_repository.dart';
...
class _CurrencyRecordRepository implements CurrencyRecordRepository {
  _CurrencyRecordRepository(this._dio, {this.baseUrl, this.errorLogger}) {
