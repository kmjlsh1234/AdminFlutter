...
class _RoleRepository implements RoleRepository {
  _RoleRepository(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<Role> getRole(int roleId) async {
    ...
    final _options = _setStreamType<Role>(
  ...
  Future<List<Role>> getTotalRoleList() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<Role>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/v1/roles/list/all',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<CountVo> getRoleListCount() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<Role> addRole(RoleAddParam roleAddParam) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(roleAddParam.toJson());
    final _options = _setStreamType<Role>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<Role> modRole(int roleId, RoleModParam roleModParam) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(roleModParam.toJson());
    final _options = _setStreamType<Role>(
  ...
  @override
  Future<HttpResponse<dynamic>> delRole(int roleId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
