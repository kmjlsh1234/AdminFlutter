...
class _BoardRepository implements BoardRepository {
  ...
  Future<Board> getBoard(int boardId) async {
    ...
    final _options = _setStreamType<Board>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/v1/boards/${boardId}',
    ...
    late Board _value;
    try {
      _value = Board.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<Board> addBoard(BoardAddParam boardAddParam) async {
    ...
    _data.addAll(boardAddParam.toJson());
    final _options = _setStreamType<Board>(
  ...
  @override
  Future<CountVo> getBoardListCount(BoardSearchParam boardSearchParam) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
