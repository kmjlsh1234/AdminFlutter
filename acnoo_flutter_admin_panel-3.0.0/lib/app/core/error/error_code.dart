enum ErrorCode {
  ...
  LOGIN_FAILURE_ADMIN_STATUS_EXIT(140205, '탈퇴 유저의 인증 시도'),
  LOGIN_FAILURE_ADMIN_STATUS_TRYEXIT(140206, '탈퇴신청한(탈퇴중) 유저의 인증 시도'),
  LOGIN_FAILURE_ADMIN_STATUS_LOGOUT(140207, '로그아웃된 토큰으로 인증 시도'),
  LOGIN_FAILURE_ADMIN_STATUS_STOP(140208, '이용정지된 유저의 로그인 시도'),
  LOGIN_FAILURE_ADMIN_STATUS_BAN(140209, '강제 차단 당한 유저의 로그인 시도'),
