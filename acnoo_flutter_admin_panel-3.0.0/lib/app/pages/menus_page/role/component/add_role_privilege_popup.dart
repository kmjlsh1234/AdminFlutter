...
class AddRolePrivilegeDialog extends StatefulWidget {
  const AddRolePrivilegeDialog({super.key, required this.rolePrivilegeList});
  final List<RolePrivilege> rolePrivilegeList;

  @override
  State<AddRolePrivilegeDialog> createState() => _AddRolePrivilegeDialogState();
}

class _AddRolePrivilegeDialogState extends State<AddRolePrivilegeDialog> {
      ...
      child: DataTable(
        ...
        rows: privilegeMenuList.map(
            ...
            return DataRow(
              ...
              cells: [
                DataCell(Text(data.privilegeMenu.parentId == null ? data.privilegeMenu.privilegeName : lang.empty)),
                DataCell(Text(data.privilegeMenu.parentId == null ? lang.empty : data.privilegeMenu.privilegeName)),
