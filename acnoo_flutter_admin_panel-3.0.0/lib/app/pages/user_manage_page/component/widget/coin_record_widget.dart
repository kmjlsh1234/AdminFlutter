...
class _CoinRecordWidgetState extends State<CoinRecordWidget> {
  ...
  //Future Model
  late Future<List<CoinRecord>> recordList;
  ...
  //기록 리스트
  Future<List<CoinRecord>> getRecordList() async {
    try {
  ...
  Theme dataTable(List<CoinRecord> recordList) {
        ...
        rows: recordList.map((data) {
            return DataRow(
              ...
              cells: [
                ...
                DataCell(Text(data.changeCoin.toString())),
                DataCell(Text(data.resultCoin.toString())),
