...
class _DiamondRecordWidgetState extends State<DiamondRecordWidget> {
  ...
  //Future Model
  late Future<List<DiamondRecord>> recordList;
  ...
  //기록 리스트
  Future<List<DiamondRecord>> getRecordList() async {
    try {
  ...
  Theme dataTable(List<DiamondRecord> recordList) {
    ...
    return Theme(
      ...
      child: DataTable(
        ...
        columns: [
          ...
          DataColumn(label: Text(lang.resultFreeAmount)),
          DataColumn(label: Text(lang.resultAndroidAmount)),
          DataColumn(label: Text(lang.resultIosAmount)),
          DataColumn(label: Text(lang.resultPaidAmount)),
        ...
        rows: recordList.map((data) {
            return DataRow(
              ...
              cells: [
                ...
                DataCell(Text(data.changeDiamond.toString())),
                DataCell(Text(data.resultFreeDiamond.toString())),
                DataCell(Text(data.resultAndroidDiamond.toString())),
                DataCell(Text(data.resultIosDiamond.toString())),
                DataCell(Text(data.resultPaidDiamond.toString())),
